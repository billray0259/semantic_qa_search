...
app.layout = html.Div([
    ...
    # Navbar
    dbc.NavbarSimple(id="navbar", brand="Semantic Question Answer Search", brand_href="/todo", color="primary", className="mb-3", dark=True),
    ...
    dbc.Row([
        dbc.Col(),
        dbc.Col(
            dbc.Input(id="search-input", type="search", placeholder="Search for a question", debounce=True, className="mb-3"),
            width=4
        ),
        dbc.Col(
